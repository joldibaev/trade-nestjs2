...
export class Init1758799447638 implements MigrationInterface {
    name = 'Init1758799447638'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."price_types_usage_enum" AS ENUM('sale', 'purchase', 'both')`);
        await queryRunner.query(`CREATE TABLE "price_types" ("id" uuid NOT NULL, "name" character varying(255) NOT NULL, "usage" "public"."price_types_usage_enum" NOT NULL DEFAULT 'sale', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_623e93be1356fb26b7241a991a3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL, "name" character varying(255) NOT NULL, "article" character varying(100) NOT NULL, "categoryId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_e3c0b01c8df8b391e132379445e" UNIQUE ("article"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "document_purchases" ("id" SERIAL NOT NULL, "performed" boolean NOT NULL DEFAULT false, "date" TIMESTAMP NOT NULL DEFAULT now(), "storeId" uuid NOT NULL, "vendorId" uuid NOT NULL, "authorId" uuid NOT NULL, "priceTypeId" uuid NOT NULL, "note" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_da3380025ccdccb4d16cb6e1dae" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5357c44be79fd8a75fa060626d" ON "document_purchases" ("performed") `);
        ...
        await queryRunner.query(`CREATE TABLE "document_sells" ("id" SERIAL NOT NULL, "performed" boolean NOT NULL DEFAULT false, "date" TIMESTAMP NOT NULL DEFAULT now(), "storeId" uuid NOT NULL, "customerId" uuid, "authorId" uuid NOT NULL, "priceTypeId" uuid NOT NULL, "note" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_077029a7529269234d0a7551259" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c9039fa5ad89b95f12ec09f252" ON "document_sells" ("performed") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_bbf6da4fa5a4071dd84f77d537" ON "document_adjustments" ("performed") `);
        await queryRunner.query(`CREATE INDEX "IDX_019aa1400ed712becd19cf57a2" ON "document_adjustments" ("date") `);
        await queryRunner.query(`CREATE TABLE "operations" ("id" uuid NOT NULL, "quantity" integer NOT NULL, "price" numeric(10,2) NOT NULL, "quantityPositive" boolean NOT NULL, "productId" uuid NOT NULL, "storeId" uuid NOT NULL, "documentPurchaseId" integer, "documentSellId" integer, "documentAdjustmentId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_7b62d84d6f9912b975987165856" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bbf6da4fa5a4071dd84f77d537"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c9039fa5ad89b95f12ec09f252"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5357c44be79fd8a75fa060626d"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."price_types_usage_enum"`);
